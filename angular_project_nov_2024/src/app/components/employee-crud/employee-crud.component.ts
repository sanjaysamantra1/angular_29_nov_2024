...
@Component({
  ...
  imports: [NgxPaginationModule, FormsModule, EmployeeListComponent, EmployeeFormModalComponent, FormModalComponent],
...
export class EmployeeCRUDComponent {
  ...
  showDeleteAlert(employee: any) {
    ...
    swalWithBootstrapButtons.fire({
      title: `Are you sure to delete an employee ${employee.name}?`,
